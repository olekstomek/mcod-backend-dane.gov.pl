/* 1. TG - applications_applicationproposal */
...
/* FUNKCJA POD TRIGGER */
CREATE OR REPLACE FUNCTION public.fn_insert_applications_applicationproposal_history()
RETURNS TRIGGER
LANGUAGE plpgsql
AS $function$
...
BEGIN
    ...
    v_functionname := 'fn_insert_applications_applicationproposal_history';
...
/* TRIGGER NA TABELI */
CREATE TRIGGER tg_applications_applicationproposal_history
AFTER INSERT OR UPDATE OR DELETE ON public.applications_applicationproposal FOR EACH ROW EXECUTE PROCEDURE public.fn_insert_applications_applicationproposal_history();
