...
/* FUNKCJA POD TRIGGER */
CREATE OR REPLACE FUNCTION public.fn_insert_academy_course_history()
RETURNS TRIGGER
LANGUAGE plpgsql
AS $function$
...
BEGIN
    ...
    v_functionname := 'fn_insert_academy_course_history';
...
/* TRIGGER NA TABELI */
CREATE TRIGGER tg_academy_course_history
AFTER INSERT OR UPDATE OR DELETE ON public.academy_course FOR EACH ROW EXECUTE PROCEDURE public.fn_insert_academy_course_history();
