...
/* FUNKCJA POD TRIGGER */
CREATE OR REPLACE FUNCTION public.fn_insert_organization_history()
  RETURNS TRIGGER
LANGUAGE plpgsql
AS $function$
...
BEGIN
  ...
  v_functionname := 'fn_insert_organization_history';
...
BEGIN;
/* TRIGGER NA TABELI */
CREATE TRIGGER tg_organization_history
  AFTER INSERT OR UPDATE OR DELETE
  ON public.organization
  FOR EACH ROW EXECUTE PROCEDURE public.fn_insert_organization_history();
