...
/* FUNKCJA POD TRIGGER */
CREATE OR REPLACE FUNCTION public.fn_insert_user_following_application_history()
  RETURNS TRIGGER
LANGUAGE plpgsql
AS $function$
...
BEGIN
  ...
  v_functionname := 'fn_insert_user_following_application_history';
...
BEGIN;
/* TRIGGER NA TABELI */
CREATE TRIGGER tg_user_following_application_history
  AFTER INSERT OR UPDATE OR DELETE
  ON public.user_following_application
  FOR EACH ROW EXECUTE PROCEDURE public.fn_insert_user_following_application_history();
