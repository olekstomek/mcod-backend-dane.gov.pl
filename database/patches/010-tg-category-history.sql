...
/* FUNKCJA POD TRIGGER */
CREATE OR REPLACE FUNCTION public.fn_insert_category_history()
  RETURNS TRIGGER
LANGUAGE plpgsql
AS $function$
...
BEGIN
  ...
  v_functionname := 'fn_insert_category_history';
...
BEGIN;
/* TRIGGER NA TABELI */
CREATE TRIGGER tg_category_history
  AFTER INSERT OR UPDATE OR DELETE
  ON public.category
  FOR EACH ROW EXECUTE PROCEDURE public.fn_insert_category_history();
