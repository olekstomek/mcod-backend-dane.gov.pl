...
(
    SELECT
        ...
        r.format,
        concat_ws(', ',
         CASE WHEN NULLIF(r.csv_file, '') IS NOT NULL THEN 'csv' ELSE NULL END,
         CASE WHEN NULLIF(r.jsonld_file, '') IS NOT NULL THEN 'json-ld' ELSE NULL END ) formaty_po_konwersji,
