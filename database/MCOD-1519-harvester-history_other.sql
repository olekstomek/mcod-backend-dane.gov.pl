...
/* FUNKCJA POD TRIGGER */
CREATE OR REPLACE FUNCTION public.fn_insert_harvester_datasource_history()
RETURNS TRIGGER
LANGUAGE plpgsql
AS $function$
...
BEGIN
    ...
    v_functionname := 'fn_insert_harvester_datasource_history';
...
/* TRIGGER NA TABELI */
CREATE TRIGGER tg_harvester_datasource_history
AFTER INSERT OR UPDATE OR DELETE ON public.harvester_datasource FOR EACH ROW EXECUTE PROCEDURE public.fn_insert_harvester_datasource_history();
