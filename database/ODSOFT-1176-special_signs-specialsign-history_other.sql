/* 1. TG - special_signs_specialsign */
...
/* FUNKCJA POD TRIGGER */
CREATE OR REPLACE FUNCTION public.fn_insert_special_signs_specialsign_history()
RETURNS TRIGGER
LANGUAGE plpgsql
AS $function$
...
BEGIN
    ...
    v_functionname := 'fn_insert_special_signs_specialsign_history';
...
/* TRIGGER NA TABELI */
CREATE TRIGGER tg_special_signs_specialsign_history
AFTER INSERT OR UPDATE OR DELETE ON public.special_signs_specialsign FOR EACH ROW EXECUTE PROCEDURE public.fn_insert_special_signs_specialsign_history();
