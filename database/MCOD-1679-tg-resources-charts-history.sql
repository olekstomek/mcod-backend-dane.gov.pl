...
/* FUNKCJA POD TRIGGER */
CREATE OR REPLACE FUNCTION public.fn_insert_resource_chart_history()
RETURNS TRIGGER
LANGUAGE plpgsql
AS $function$
...
BEGIN
    ...
    v_functionname := 'fn_insert_resource_chart_history';
...
/* TRIGGER NA TABELI */
CREATE TRIGGER tg_resource_chart_history
AFTER INSERT OR UPDATE OR DELETE ON public.resource_chart FOR EACH ROW EXECUTE PROCEDURE public.fn_insert_resource_chart_history();