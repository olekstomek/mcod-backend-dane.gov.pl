...
/* FUNKCJA POD TRIGGER */
CREATE OR REPLACE FUNCTION public.fn_insert_suggestions_datasetsubmission_history()
RETURNS TRIGGER
LANGUAGE plpgsql
AS $function$
...
BEGIN
    ...
    v_functionname := 'fn_insert_suggestions_datasetsubmission_history';
...
/* TRIGGER NA TABELI */
CREATE TRIGGER tg_suggestions_datasetsubmission_history
AFTER INSERT OR UPDATE OR DELETE ON public.suggestions_datasetsubmission FOR EACH ROW EXECUTE PROCEDURE public.fn_insert_suggestions_datasetsubmission_history();
