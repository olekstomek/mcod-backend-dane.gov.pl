...
/* FUNKCJA POD TRIGGER */
CREATE OR REPLACE FUNCTION public.fn_insert_laboratory_history()
RETURNS TRIGGER
LANGUAGE plpgsql
AS $function$
...
BEGIN
    ...
    v_functionname := 'fn_insert_laboratory_history';
...
/* TRIGGER NA TABELI */
CREATE TRIGGER tg_labevents_history
AFTER INSERT OR UPDATE OR DELETE ON public.lab_event FOR EACH ROW EXECUTE PROCEDURE public.fn_insert_laboratory_history();
