...
/* FUNKCJA POD TRIGGER */
CREATE OR REPLACE FUNCTION public.fn_insert_users_meeting_history()
RETURNS TRIGGER
LANGUAGE plpgsql
AS $function$
...
BEGIN
    ...
    v_functionname := 'fn_insert_users_meeting_history';
...
/* TRIGGER NA TABELI */
CREATE TRIGGER tg_users_meeting_history
AFTER INSERT OR UPDATE OR DELETE ON public.users_meeting FOR EACH ROW EXECUTE PROCEDURE public.fn_insert_users_meeting_history();
