...
/* FUNKCJA POD TRIGGER */
CREATE OR REPLACE FUNCTION public.fn_insert_suggestions_datasetcomment_history()
RETURNS TRIGGER
LANGUAGE plpgsql
AS $function$
...
BEGIN
    ...
    v_functionname := 'fn_insert_suggestions_datasetcomment_history';
...
/* TRIGGER NA TABELI */
CREATE TRIGGER tg_suggestions_datasetcomment_history
AFTER INSERT OR UPDATE OR DELETE ON public.suggestions_datasetcomment FOR EACH ROW EXECUTE PROCEDURE public.fn_insert_suggestions_datasetcomment_history();
