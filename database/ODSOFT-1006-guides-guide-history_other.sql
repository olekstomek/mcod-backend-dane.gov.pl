...
/* FUNKCJA POD TRIGGER */
CREATE OR REPLACE FUNCTION public.fn_insert_guides_guide_history()
RETURNS TRIGGER
LANGUAGE plpgsql
AS $function$
...
BEGIN
    ...
    v_functionname := 'fn_insert_guides_guide_history';
...
/* TRIGGER NA TABELI */
CREATE TRIGGER tg_guides_guide_history
AFTER INSERT OR UPDATE OR DELETE ON public.guides_guide FOR EACH ROW EXECUTE PROCEDURE public.fn_insert_guides_guide_history();
