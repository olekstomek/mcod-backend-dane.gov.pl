    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(null=True, verbose_name='meeting date')),
                ...
                ('members', models.ManyToManyField(related_name='meetings', to=settings.AUTH_USER_MODEL, verbose_name='members')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published_at', model_utils.fields.MonitorField(default=django.utils.timezone.now, monitor='status', when={'published'})),
                ('views_count', models.PositiveIntegerField(default=0)),
                ('file', models.FileField(max_length=2000, storage=mcod.core.storages.MeetingStorage(base_url=None, location=None), upload_to='', verbose_name='file')),
                ('i18n', modeltrans.fields.TranslationField(fields=('slug',), required_languages=(), virtual_fields=True)),
                ('meeting', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='files', to='users.Meeting')),
            ],
            options={
