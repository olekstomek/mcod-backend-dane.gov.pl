...
class SKOSConcept(RDFClass):
    ...
    title_pl = RDFField(predicate=ns.SKOS.prefLabel, object_type=partial(Literal, lang='pl'), required=False)
    title_en = RDFField(predicate=ns.SKOS.prefLabel, object_type=partial(Literal, lang='en'), required=False)
...
class VCARDKind(RDFClass):
    ...
    name = RDFField(predicate=ns.VCARD.fn, object_type=partial(Literal, datatype=XSD.string), allow_null=False)
...
class FOAFAgent(RDFClass):
    ...
    title_pl = RDFField(predicate=ns.FOAF.name, object_type=partial(Literal, lang='pl'), allow_null=False)
    title_en = RDFField(predicate=ns.FOAF.name, object_type=partial(Literal, lang='en'), allow_null=False)
...
class DCATDistribution(RDFClass):
    ...
    description_pl = RDFField(predicate=ns.DCT.description, object_type=partial(Literal, lang='pl'), allow_null=False)
    description_en = RDFField(predicate=ns.DCT.description, object_type=partial(Literal, lang='en'), allow_null=False)
...
class DCATDataset(RDFClass):
    ...
    title_pl = RDFField(predicate=ns.DCT.title, object_type=partial(Literal, lang='pl'))
    title_en = RDFField(predicate=ns.DCT.title, object_type=partial(Literal, lang='en'), allow_null=False)
    notes_pl = RDFField(predicate=ns.DCT.description, object_type=partial(Literal, lang='pl'), allow_null=False)
    notes_en = RDFField(predicate=ns.DCT.description, object_type=partial(Literal, lang='en'), allow_null=False)
...
class DCATCatalog(RDFClass):
    ...
    title_pl = RDFField(predicate=ns.DCT.title, object_type=partial(Literal, lang='pl'), allow_null=False)
    title_en = RDFField(predicate=ns.DCT.title, object_type=partial(Literal, lang='en'), allow_null=False)
    description_pl = RDFField(predicate=ns.DCT.description, object_type=partial(Literal, lang='pl'), allow_null=False)
    description_en = RDFField(predicate=ns.DCT.description, object_type=partial(Literal, lang='en'), allow_null=False)
...
class LicenseDCATVocabularyField(DCATVocabularyField):
    ...
    def parse_value(self, value):
        ...
        license_names = {license_name.replace(' ', '_').replace('-', '_').replace('.', '_'): license_name
...
class BaseDCATDeserializer(RDFClass):
    ...
    description_pl = RDFField(predicate=ns.DCT.description, object_type=partial(Literal, lang='pl'), try_non_lang=True)
    ...
    def get_ext_ident_object(self, triple_store, subject, field):
        ident = [value.split('/')[-1] if _is_valid_uri(value) else value for
                 value in triple_store.objects(subject=subject, predicate=field.predicate)]
...
class DCATDatasetDeserializer(BaseDCATDeserializer):
    ...
    def get_tags_object(self, triple_store, subject, field):
        return [{'name': value.value, 'lang': value.language}
                if value.language in ('pl', 'en') else
                {'name': value.value} if not value.language else {}
