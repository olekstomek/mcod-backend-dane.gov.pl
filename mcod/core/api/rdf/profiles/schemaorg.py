...
class SCHEMACatalog(RDFClass):
    ...
    title_en = RDFField(predicate=ns.SCHEMA.name, object_type=partial(Literal, lang='en'), allow_null=False)
    description_pl = RDFField(predicate=ns.SCHEMA.description, object_type=partial(Literal, lang='pl'), allow_null=False)
    description_en = RDFField(predicate=ns.SCHEMA.description, object_type=partial(Literal, lang='en'), allow_null=False)
...
class SCHEMADataset(RDFClass):
    ...
    title_pl = RDFField(predicate=ns.SCHEMA.name, object_type=partial(Literal, lang='pl'))
    title_en = RDFField(predicate=ns.SCHEMA.name, object_type=partial(Literal, lang='en'), allow_null=False)
    notes_pl = RDFField(predicate=ns.SCHEMA.description, object_type=partial(Literal, lang='pl'), allow_null=False)
    notes_en = RDFField(predicate=ns.SCHEMA.description, object_type=partial(Literal, lang='en'), allow_null=False)
