...
class VocabSKOSConcept(RDFClass):
    ...
    name_pl = RDFField(predicate=ns.SKOS.prefLabel, object_type=partial(Literal, lang='pl'), required=False)
    name_en = RDFField(predicate=ns.SKOS.prefLabel, object_type=partial(Literal, lang='en'), required=False)
    description_pl = RDFField(predicate=ns.SKOS.definition, object_type=partial(Literal, lang='pl'), required=False)
    description_en = RDFField(predicate=ns.SKOS.definition, object_type=partial(Literal, lang='en'), required=False)
