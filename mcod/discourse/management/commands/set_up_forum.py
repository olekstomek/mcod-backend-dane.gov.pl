...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--file', metavar="filename", type=argparse.FileType('r'), help="read config from json file")
        parser.add_argument(dest="keyval", nargs="*", metavar="KEY=VALUE",
