...
class TranslatedTextField(fields.NestedField):
    ...
    def __init__(self, field_name, *args, raw_field_cls=None, attr=None, analyzers=None, properties=None, **kwargs):
        raw_field_cls = raw_field_cls if raw_field_cls else fields.KeywordField
        if not properties:
            properties = {
                lang_code: fields.TextField(fields={
                    'raw': raw_field_cls(),
...
class TranslatedSuggestField(TranslatedTextField):
    def __init__(self, field_name, *args, attr=None, analyzers=None, properties=None, **kwargs):
        ...
        super().__init__(field_name, *args, attr=attr, analyzers=analyzers, properties=properties, **kwargs)


class TranslatedKeywordField(fields.NestedField):
    def __init__(self, field_name, *args, attr=None, field_kwargs=None, properties=None, multi=True, **kwargs):
