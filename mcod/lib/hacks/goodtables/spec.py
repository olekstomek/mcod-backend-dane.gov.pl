...
spec = {'errors': {'blank-header': {'context': 'head',
                                    ...
                                    'type': 'structure',
                                    'weight': 3},
                   'blank-row': {'context': 'body',
                                 'description': _('This row is empty. A row should '
                                 ...
                                 'type': 'structure',
                                 'weight': 9},
                   'duplicate-header': {'context': 'head',
                                        'description': _('Two columns in the header row '
                                                         ...
                                                         '{validator}.'),
                                        'message': _('Header in column {column_number} '
                                                     'is duplicated to header in '
                                                     'column(s) {column_numbers}'),
                                        'name': _('Duplicate Header'),
                                        'type': 'structure',
                                        'weight': 3},
                   'duplicate-row': {'context': 'body',
                                     'description': _('The exact same data has been '
                                                      'seen in another row.\n'
                                                      '\n'
                                                      ' How it could be resolved:\n'
                                                      ...
                                                      'check in {validator}.'),
                                     'message': _('Row {row_number} is duplicated to '
                                                  'row(s) {row_numbers}'),
                                     'name': _('Duplicate Row'),
                                     'type': 'structure',
                                     'weight': 5},
                   'encoding-error': {'context': 'table',
                                      'description': _('Data reading error because of '
                                                       'an encoding problem.\n'
                                                       '\n'
                                                       ' How it could be resolved:\n'
                                                       ...
                                                       '{validator}.'),
                                      'message': _('The data source could not be '
                                                   'successfully decoded with '
                                                   '{encoding} encoding'),
                                      'name': _('Encoding Error'),
                                      'type': 'source',
                                      'weight': 100},
                   'enumerable-constraint': {'context': 'body',
                                             'description': _('This field value should '
                                                              ...
                                                              'check in {validator}.'),
                                             'message': _('The value {value} in row '
                                             ...
                                             'type': 'schema',
                                             'weight': 7},
                   'extra-header': {'context': 'head',
                                    'description': _('The first row of the data source '
                                                     ...
                                                     'check in {validator}.'),
                                    'message': _('There is an extra header in column '
                                                 '{column_number}'),
                                    'name': _('Extra Header'),
                                    'type': 'schema',
                                    'weight': 9},
                   'extra-value': {'context': 'body',
                                   'description': _('This row has more values compared '
                                                    ...
                                                    '{validator}.'),
                                   'message': _('Row {row_number} has an extra value in '
                                                'column {column_number}'),
                                   'name': _('Extra Value'),
                                   'type': 'structure',
                                   'weight': 9},
                   'format-error': {'context': 'table',
                                    'description': _('Data reading error because of '
                                                     'incorrect format.\n'
                                                     '\n'
                                                     ' How it could be resolved:\n'
                                                     ...
                                                     '{validator}.'),
                                    'message': _('The data source is in an unknown '
                                                 'format; no tabular data can be '
                                                 'extracted'),
                                    'name': _('Format Error'),
                                    'type': 'source',
                                    'weight': 100},
                   'http-error': {'context': 'table',
                                  'description': _('Data reading error because of HTTP '
                                                   'error.\n'
                                                   '\n'
                                                   ' How it could be resolved:\n'
                                                   " - Fix url link if it's not "
                                                   'correct.'),
                                  'message': _('The data source returned an HTTP error '
                                               'with a status code of {status_code}'),
                                  'name': _('HTTP Error'),
                                  'type': 'source',
                                  'weight': 100},
                   'io-error': {'context': 'table',
                                'description': _('Data reading error because of IO '
                                                 'error.\n'
                                                 '\n'
                                                 ' How it could be resolved:\n'
                                                 " - Fix path if it's not correct."),
                                'message': _('The data source returned an IO Error of '
                                             'type {error_type}'),
                                'name': _('IO Error'),
                                'type': 'source',
                                'weight': 100},
                   'maximum-constraint': {'context': 'body',
                                          'description': _('This field value should be '
                                                           'less or equal than '
                                                           'constraint value.\n'
                                                           '\n'
                                                           ' How it could be resolved:\n'
                                          ...
                                          'type': 'schema',
                                          'weight': 7},
                   'maximum-length-constraint': {'context': 'body',
                                                 'description': _('A length of this '
                                                                  'field value should '
                                                                  'be less or equal '
                                                                  'than schema '
                                                                  'constraint value.\n'
                                                 ...
                                                 'type': 'schema',
                                                 'weight': 7},
                   'minimum-constraint': {'context': 'body',
                                          'description': _('This field value should be '
                                          ...
                                          'type': 'schema',
                                          'weight': 7},
                   'minimum-length-constraint': {'context': 'body',
                                                 'description': _('A length of this '
                                                                  'field value should '
                                                                  'be greater or equal '
                                                                  'than schema '
                                                 ...
                                                 'type': 'schema',
                                                 'weight': 7},
                   'missing-header': {'context': 'head',
                                      'description': _('Based on the schema there '
                                                       ...
                                                       '{validator}.'),
                                      'message': _('There is a missing header in column '
                                                   '{column_number}'),
                                      'name': _('Missing Header'),
                                      'type': 'schema',
                                      'weight': 9},
                   'missing-value': {'context': 'body',
                                     'description': _('This row has less values '
                                                      ...
                                                      'check in {validator}.'),
                                     'message': _('Row {row_number} has a missing value '
                                                  'in column {column_number}'),
                                     'name': _('Missing Value'),
                                     'type': 'structure',
                                     'weight': 9},
                   'non-matching-header': {'context': 'head',
                                           'description': _('One of the data source '
                                                            ...
                                                            '`non-matching-header` '
                                                            'check in {validator}.'),
                                           'message': _('Header in column '
                                                        "{column_number} doesn't match "
                                                        'field name {field_name} in the '
                                                        'schema'),
                                           'name': _('Non-Matching Header'),
                                           'type': 'schema',
                                           'weight': 9},
                   'pattern-constraint': {'context': 'body',
                                          'description': _('This field value should '
                                          ...
                                          'type': 'schema',
                                          'weight': 7},
                   'required-constraint': {'context': 'body',
                                           'description': _('This field is a required '
                                                            ...
                                                            '`required-constraint` '
                                                            'check in {validator}.'),
                                           'message': _('Column {column_number} is a '
                                                        'required field, but row '
                                                        '{row_number} has no value'),
                                           'name': _('Required Constraint'),
                                           'type': 'schema',
                                           'weight': 9},
                   'schema-error': {'context': 'table',
                   ...
                   'scheme-error': {'context': 'table',
                                    'description': _('Data reading error because of '
                                                     ...
                                                     '{validator}.'),
                                    'message': _('The data source is in an unknown '
                                                 'scheme; no tabular data can be '
                                                 'extracted'),
                                    'name': _('Scheme Error'),
                                    'type': 'source',
                                    'weight': 100},
                   'source-error': {'context': 'table',
                                    'description': _('Data reading error because of not '
                                                     ...
                                                     '{validator}.'),
                                    'message': _('The data source has not supported or '
                                                 'has inconsistent contents; no tabular '
                                                 'data can be extracted'),
                                    'name': _('Source Error'),
                                    'type': 'source',
                                    'weight': 100},
                   'type-or-format-error': {'context': 'body',
                                            'description': _('The value does not match '
                                                             'the schema type and '
                                            ...
                                            'type': 'schema',
                                            'weight': 9},
                   'unique-constraint': {'context': 'body',
                                         'description': _('This field is a unique field '
                                                          ...
                                                          '{validator}.'),
                                         'message': _('Rows {row_numbers} has unique '
                                                      'constraint violation in column '
                                                      '{column_number}'),
