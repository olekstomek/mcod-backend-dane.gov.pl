...
def test_catalog_rdf_in_default_profile(dataset_with_resource, client14, constance_config):
...
@pytest.mark.elasticsearch
def test_catalog_rdf_in_dcat_ap_profile(dataset_with_resource, client14, constance_config):
    dataset = dataset_with_resource
...
@pytest.mark.elasticsearch
def test_dataset_rdf_in_default_profile(dataset_with_resource, client14, constance_config):
    dataset = dataset_with_resource
...
@pytest.mark.elasticsearch
def test_dataset_rdf_in_dcat_ap_profile(dataset_with_resource, client14, constance_config):
    dataset = dataset_with_resource
