Feature: Custom urls
  Scenario Outline: Custom url to dataset details works ok
    ...
    | dataset     | {"id": 999, "has_high_value_data": true, "has_dynamic_data": true}   | {"has_high_value_data": true, "has_dynamic_data": true}   |
    | dataset     | {"id": 999, "has_high_value_data": false, "has_dynamic_data": false} | {"has_high_value_data": false, "has_dynamic_data": false} |
    | dataset     | {"id": 999, "has_high_value_data": null, "has_dynamic_data": null}   | {"has_high_value_data": null, "has_dynamic_data": null}   |
