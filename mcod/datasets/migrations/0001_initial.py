    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license_old_id', models.CharField(blank=True, max_length=20, null=True, verbose_name='License ID')),
                ('customfields',
                 django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True, verbose_name='Customfields')),

                ('license_condition_db_or_copyrighted', models.CharField(blank=True, max_length=300, null=True)),
                ('license_condition_modification', models.NullBooleanField(default=None)),
                ...
                ('update_frequency',
                 models.CharField(blank=True, max_length=50, null=True, verbose_name='Update frequency')),
