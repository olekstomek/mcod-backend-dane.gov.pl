...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("non_empty_graph_without_namespace", "nq", "application/n-quads", "n3", 4, 4),
        ("non_empty_graph_with_two_namespaces", "n3", "application/n-quads", "n3", 5, 5),
        ("non_empty_graph_with_namespace", "n3", "application/n-quads", "n3", 4, 4),
        # nquads
        ...
        ("non_empty_graph_without_namespace", "nquads", "application/n-quads", "n3", 4, 4),
        ("non_empty_graph_with_two_namespaces", "nquads", "application/n-quads", "n3", 5, 5),
        ("non_empty_graph_with_namespace", "nquads", "application/n-quads", "n3", 4, 4),
        # nt
