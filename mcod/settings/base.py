...
RESOURCE_MAX_REPORT_SIZE = env.int("RESOURCE_MAX_REPORT_SIZE", 100_000)  # rows
...
ALLOWED_SPARQL_EXTERNAL_DOMAINS = env.list(
    "ALLOWED_SPARQL_EXTERNAL_DOMAINS",
    default=["dane.gov.pl", "kronika.gov.pl"],
)
