...
class DataSourceAdminForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'license_condition_db_or_copyrighted': forms.Textarea(
                attrs={'cols': '80', 'class': 'input-block-level'}),
...
class DataSourceImportAdminForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = (
            'datasource', 'start', 'end', 'datasets_count', 'datasets_created_count', 'datasets_deleted_count',
            'resources_count', 'resources_created_count', 'resources_deleted_count', 'status')
