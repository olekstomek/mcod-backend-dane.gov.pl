...
routes = [
    ...
    ('/catalog/dataset/{id:int}.{rdf_format:rdf_format}', dataset_views.DatasetRDFView()),
    ('/catalog/dataset/{id:int}', dataset_views.DatasetRDFView()),
    ('/catalog/dataset/{id:int},{slug}.{rdf_format:rdf_format}', dataset_views.DatasetRDFView()),
    ('/catalog/dataset/{id:int},{slug}', dataset_views.DatasetRDFView()),
    ('/catalog/dataset/{id:int}/resource/{res_id:int}.{rdf_format:rdf_format}', res_views.ResourceRDFView()),
    ...
    *dataset_showcases,
    ...
    ('/submissions/accepted/public/{id:int}', submission_views.AcceptedSubmissionDetailView(), 'public_submission'),
    ('/submissions/accepted/public/{id:int}/comment', submission_views.AcceptedDatasetSubmissionCommentView()),
    # LOD
    ('/laboratory', laboratory_views.LaboratorySearchApiView()),
    # Newsletter
    ('/auth/newsletter/subscribe', newsletter_views.SubscribeNewsletterView()),
    ('/auth/newsletter/subscribe/{activation_code:uuid}/confirm', newsletter_views.ConfirmNewsletterView()),
