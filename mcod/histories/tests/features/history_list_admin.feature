Feature: History list page in admin panel
    ...
    And admin's response page contains <a href="/histories/logentry/" class="changelink icon">
  ...
  Scenario: History section is not visible for editor user
    ...
    And admin's response page not contains <a href="/histories/logentry/" class="changelink icon">
