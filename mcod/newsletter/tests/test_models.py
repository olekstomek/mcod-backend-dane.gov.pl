...
class TestSubscriptionModel(object):
    ...
    def test_subscribe_confirm_absolute_url_with_proper_lang(
            self, newsletter_subscription):
        ...
        nl =\
            Newsletter.objects.create(
                file=SimpleUploadedFile(
                    'test.html', '<html><head></head><body>ąśćężź <a href="#">Resign</a>'
                                 ' <a href="#">Rezygnacja</a></body></html>'.encode('cp1250'),
                    content_type='text/html'), title='test-title', planned_sending_date=date.today(), created_by=admin)
        nl.clean()
