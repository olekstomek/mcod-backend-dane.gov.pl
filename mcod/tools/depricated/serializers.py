...
class StatsAggregations(ArgsListToDict):
    ...
    datasets_by_categories = ma.fields.Nested(StatsBucketItem(app='categories', model='Category'),
                                              attribute='datasets_by_categories.inner.buckets', many=True)
    ...
    datasets_by_keyword = ma.fields.Nested(KeywordBucketItem(), attribute='datasets_by_keyword.inner.inner.buckets', many=True)
