...
@pytest.mark.elasticsearch
def test_routes_id_and_slug_in_link_institution_datasets_list(institution_with_datasets,
                                                              client14):
...
@pytest.mark.elasticsearch
def test_routes_id_without_slug_in_link_institution_datasets_list(institution_with_datasets,
                                                                  client14):
    inst = institution_with_datasets
