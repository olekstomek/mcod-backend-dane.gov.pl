...
def register_forms_menu_item():
    return FormsMenuItem(
        _('Ankiety'), reverse('cms_forms_index'),
...
def global_admin_css():
    return format_html_join('\n', '<link rel="stylesheet" href="{}">', ((static(css),) for css in CUSTOM_STYLESHEETS))
...
def register_lang_en_feature(features):
    ...
    for lang_code, lang_name in languages.items():
        ...
        features.register_converter_rule('contentstate', feature_name, {
            ...
            'to_database_format': {'style_map': {type_: {'element': 'span', 'props': {'dir': 'ltr', 'lang': lang_code}}}},
        })
...
def register_external_link(features):
    ...
    features.register_editor_plugin(
        'draftail', 'titled_link', draftail_features.EntityFeature({
            'type': 'TITLED_LINK',
            'icon': 'link',
            'description': 'Link',
    ...
    features.register_converter_rule('contentstate', 'titled_link', {
