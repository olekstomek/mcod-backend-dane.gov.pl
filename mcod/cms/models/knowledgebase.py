...
class KBRootPage(BasePage):
    ...
    api_fields = BasePage.api_fields + [
        APIField('top_content_box', serializer=StreamFieldSerializer(source='top_content_box_i18n')),
        APIField('body', serializer=HyperEditorJSONField(source='body_i18n')),
        APIField('bottom_content_box', serializer=StreamFieldSerializer(source='bottom_content_box_i18n'))
    ]
    ...
    i18n_fields = BasePage.i18n_fields + ['body', 'top_content_box', 'bottom_content_box']
