    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region_type', models.CharField(choices=[('locality', 'locality'), ('localadmin', 'localadmin'), ('county', 'county'), ('region', 'region')], max_length=15)),
                ('bbox', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True, verbose_name='Boundary box')),
