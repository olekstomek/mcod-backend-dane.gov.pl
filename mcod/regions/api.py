...
class BaseApi:
    ...
    def get_teryt_area_lineage(self, props):
        try:
            admin_area_id = props['addendum']['terytdata'].get('teryt_admin_area_id') if\
                props['layer'] == 'locality' else props['id']
        except KeyError:
            admin_area_id = ''
...
class PlaceholderApi(BaseApi):
    ...
    def convert_to_placeholder_format(self, regions_list, wof_teryt_mapping):
        ...
        for region in regions_list:
            ...
            name_ =\
                teryt_name if teryt_name is not None and teryt_name.lower() != props['name'].lower() else props['name']
            ...
            reg_data[props['id']] = {
                ...
                'lineage_names': {r_type[:-3]: props[r_type[:-3]] for r_type in self.hierarchy_region_labels if
                                  props.get(r_type[:-3])},
                'geom': {
    ...
    def get_wof_teryt_mapping(self, all_regions):
        ...
        for place in all_regions:
            ...
            if wof_gid:
                ...
                wof_teryt_mapping[wof_id] = {'teryt_id': props['id'],
                                             'layer': props['layer']}
